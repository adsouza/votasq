...
mixin _$Problem {
 ...
 String get id; String get description; DateTime get createdAt; DateTime get lastUpdatedAt; String get ownerId; String get geoscope; String? get lang; int get votes; List<String> get complaints; bool get solved; int get version;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,description,createdAt,lastUpdatedAt,ownerId,geoscope,lang,votes,const DeepCollectionEquality().hash(complaints),solved,version);

@override
String toString() {
  return 'Problem(id: $id, description: $description, createdAt: $createdAt, lastUpdatedAt: $lastUpdatedAt, ownerId: $ownerId, geoscope: $geoscope, lang: $lang, votes: $votes, complaints: $complaints, solved: $solved, version: $version)';
}
...
@useResult
$Res call({
 String id, String description, DateTime createdAt, DateTime lastUpdatedAt, String ownerId, String geoscope, String? lang, int votes, List<String> complaints, bool solved, int version
});
...
/// Create a copy of Problem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? description = null,Object? createdAt = null,Object? lastUpdatedAt = null,Object? ownerId = null,Object? geoscope = null,Object? lang = freezed,Object? votes = null,Object? complaints = null,Object? solved = null,Object? version = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String description,  DateTime createdAt,  DateTime lastUpdatedAt,  String ownerId,  String geoscope,  String? lang,  int votes,  List<String> complaints,  bool solved,  int version)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Problem() when $default != null:
return $default(_that.id,_that.description,_that.createdAt,_that.lastUpdatedAt,_that.ownerId,_that.geoscope,_that.lang,_that.votes,_that.complaints,_that.solved,_that.version);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String description,  DateTime createdAt,  DateTime lastUpdatedAt,  String ownerId,  String geoscope,  String? lang,  int votes,  List<String> complaints,  bool solved,  int version)  $default,) {final _that = this;
switch (_that) {
case _Problem():
return $default(_that.id,_that.description,_that.createdAt,_that.lastUpdatedAt,_that.ownerId,_that.geoscope,_that.lang,_that.votes,_that.complaints,_that.solved,_that.version);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String description,  DateTime createdAt,  DateTime lastUpdatedAt,  String ownerId,  String geoscope,  String? lang,  int votes,  List<String> complaints,  bool solved,  int version)?  $default,) {final _that = this;
switch (_that) {
case _Problem() when $default != null:
return $default(_that.id,_that.description,_that.createdAt,_that.lastUpdatedAt,_that.ownerId,_that.geoscope,_that.lang,_that.votes,_that.complaints,_that.solved,_that.version);case _:
  return null;
...
class _Problem implements Problem {
  const _Problem({required this.id, required this.description, required this.createdAt, required this.lastUpdatedAt, required this.ownerId, this.geoscope = '/', this.lang, this.votes = 1, final  List<String> complaints = const [], this.solved = false, this.version = 1}): _complaints = complaints;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,description,createdAt,lastUpdatedAt,ownerId,geoscope,lang,votes,const DeepCollectionEquality().hash(_complaints),solved,version);
...
/// Create a copy of Problem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? description = null,Object? createdAt = null,Object? lastUpdatedAt = null,Object? ownerId = null,Object? geoscope = null,Object? lang = freezed,Object? votes = null,Object? complaints = null,Object? solved = null,Object? version = null,}) {
