...
ApiResponse<T> _$ApiResponseFromJson<T>(
  Map<String, dynamic> json,T Function(Object?) fromJsonT
        ...
        switch (json['runtimeType']) {
                  case 'success':
          return Success<T>.fromJson(
            json,fromJsonT
          );
                case 'error':
          return Error<T>.fromJson(
            json,fromJsonT
          );
                case 'loading':
          return Loading<T>.fromJson(
            json,fromJsonT
          );
...
class Success<T> implements ApiResponse<T> {
  const Success(this.data, {final  String? $type}): $type = $type ?? 'success';
  factory Success.fromJson(Map<String, dynamic> json,T Function(Object?) fromJsonT) => _$SuccessFromJson(json,fromJsonT);
...
class Error<T> implements ApiResponse<T> {
  const Error(this.message, {final  String? $type}): $type = $type ?? 'error';
  factory Error.fromJson(Map<String, dynamic> json,T Function(Object?) fromJsonT) => _$ErrorFromJson(json,fromJsonT);
...
class Loading<T> implements ApiResponse<T> {
  ...
  factory Loading.fromJson(Map<String, dynamic> json,T Function(Object?) fromJsonT) => _$LoadingFromJson(json,fromJsonT);
